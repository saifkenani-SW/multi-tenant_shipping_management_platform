...
import { UpdateOrganizationUnitPayload } from '../payloads';
import { OrganizationUnitAuthorizationStrategy } from './interfaces/organization-unit-authorization-strategy.interface';

@Injectable()
export class UpdateOrganizationUnitStrategy implements OrganizationUnitAuthorizationStrategy<UpdateOrganizationUnitPayload> {
  readonly action = OrganizationUnitAction.Update;
