...
import { ManageCoveragePayload } from '../payloads';
import { OrganizationUnitAuthorizationStrategy } from './interfaces/organization-unit-authorization-strategy.interface';

@Injectable()
export class ManageCoverageStrategy implements OrganizationUnitAuthorizationStrategy<ManageCoveragePayload> {
  readonly action = OrganizationUnitAction.ManageCoverage;
