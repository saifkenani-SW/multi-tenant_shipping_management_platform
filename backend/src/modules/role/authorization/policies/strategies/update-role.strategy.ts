...
import { UpdateRolePayload } from '../payloads';
import { RoleAuthorizationStrategy } from './interfaces/role-authorization-strategy.interface';

@Injectable()
export class UpdateRoleStrategy implements RoleAuthorizationStrategy<UpdateRolePayload> {
  readonly action = RoleAction.Update;
