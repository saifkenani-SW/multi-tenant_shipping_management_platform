...
export class QuotationQueryService {
  ...
  private async enrichQuotations(
    ...
    return rawQuotations.map((q) => ({
      ...
      basePrice: q.base_price != null ? Number(q.base_price) : null,
      weightCharge: q.weight_charge != null ? Number(q.weight_charge) : null,
      extraFees: q.extra_fees != null ? Number(q.extra_fees) : null,
