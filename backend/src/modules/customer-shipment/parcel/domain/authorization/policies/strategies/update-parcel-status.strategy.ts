...
@Injectable()
export class UpdateParcelStatusStrategy implements ParcelAuthorizationStrategy<ParcelActionPayload> {
  readonly action = ParcelAction.UpdateStatus;
  ...
  async authorize(
    ...
    if (
      !ability.can(ParcelAction.UpdateStatus, subject(ParcelSubject, entity))
    ) {
