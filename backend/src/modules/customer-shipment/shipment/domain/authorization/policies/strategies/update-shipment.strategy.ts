...
@Injectable()
export class UpdateShipmentStrategy implements ShipmentAuthorizationStrategy<ShipmentActionPayload> {
  readonly action = ShipmentAction.Update;
  ...
  async authorize(
    ...
    if (!ability.can(ShipmentAction.Update, subject(ShipmentSubject, entity))) {
