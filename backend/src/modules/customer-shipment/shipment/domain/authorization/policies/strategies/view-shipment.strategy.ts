...
@Injectable()
export class ViewShipmentStrategy implements ShipmentAuthorizationStrategy<ShipmentActionPayload> {
  readonly action = ShipmentAction.View;
  ...
  async authorize(
    ...
    if (!ability.can(ShipmentAction.View, subject(ShipmentSubject, entity))) {
