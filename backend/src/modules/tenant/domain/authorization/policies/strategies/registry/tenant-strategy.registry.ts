...
import { ManageSubscriptionStrategy } from '../manage-subscription.strategy';
...
export class TenantStrategyRegistry {
  ...
  constructor(
    ...
    manageSubscriptionStrategy: ManageSubscriptionStrategy,
  ) {
    ...
    this.strategies.set(
      manageSubscriptionStrategy.action,
