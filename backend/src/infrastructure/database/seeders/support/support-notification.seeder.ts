  ...
  async seed(): Promise<void> {
    ...
    const ticket = await this.prisma.support_ticket.upsert({
      ...
      create: {
        ...
        subject: 'Inquiry regarding parcel delivery timeline',
    ...
    await this.prisma.support_ticket_message.upsert({
      where: { id: msgId },
      update: {
        message: 'When will my parcel be delivered?',
      },
      create: {
        id: msgId,
        ticket_id: ticket.id,
    ...
    await this.prisma.notification.upsert({
      ...
      create: {
        ...
        body: 'Your shipment has been created and is now processing.',
    ...
    await this.prisma.audit_log.upsert({
      ...
      create: {
        ...
        actor_ip: '127.0.0.1',
        actor_user_agent: 'PostmanRuntime/7.32.3',
        event_type: 'SHIPMENT_CREATED',
