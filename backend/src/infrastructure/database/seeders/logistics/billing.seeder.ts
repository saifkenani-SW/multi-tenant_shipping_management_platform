...
const INVOICES = [
  ...
  },
  {
    ...
    paymentId: '00000000-0000-7000-8000-000000000914',
    tenantIndex: 0,
    ...
    status: InvoiceStatus.PAID,
    method: PaymentMethod.CASH,
    reference: 'CASH-ALP-7710',
  },
  {
    id: '00000000-0000-7000-8000-000000000905',
    paymentId: null,
    tenantIndex: 0,
  ...
  {
    id: '00000000-0000-7000-8000-000000000906',
    paymentId: '00000000-0000-7000-8000-000000000916',
    tenantIndex: 0,
