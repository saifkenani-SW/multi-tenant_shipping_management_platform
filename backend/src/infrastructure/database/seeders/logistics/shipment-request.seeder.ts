  ...
  async seed(): Promise<void> {
    ...
    for (let i = 0; i < SEEDED_TENANTS.length; i++) {
      ...
      if (!customer || !orgUnit || !employee) {
        this.logger.warn(
          `Skipping ShipmentRequestSeeder for tenant ${tenant.name}: missing customer/orgUnit/employee`,
        );
        continue;
      }

      const reqId = `00000000-0000-7000-8000-00000000080${i + 1}`;
      ...
      const quoteId = `00000000-0000-7000-8000-00000000081${i + 1}`;
      ...
      const shipmentId = `00000000-0000-7000-8000-00000000082${i + 1}`;
